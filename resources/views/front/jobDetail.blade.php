                    ...
                    <div class="card shadow border-0">
                        <div class="job_details_header">
                            <div class="single_jobs white-bg d-flex justify-content-between">
                                ...
                                <div class="jobs_right">
                                    <div class="apply_now">
                                        <a class="heart_mark {{ ($countSavedJob==1) ? 'saved-job' :'' }}" href="javascript:void(0);" onclick="savedJob({{ $job->id }})"> <i class="fa fa-heart-o"
                        ...
                        <div class="descript_wrap white-bg">
                            ...
                            @if (Auth::check())
                                ...
                                @else
                                    <a href="#" class="btn btn-primary disabled">Login to Save</a>
                                @endif
