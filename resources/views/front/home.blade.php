                    ...
                    <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                        <select name="category" id="category" class="form-control">
                            ...
                            @if($new_categories!='')
                                ...
                                <option value="{{ $new_categorie->id }}">{{ $new_categorie->name }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="job_listing_area">
                    <div class="job_lists">
                        <div class="row">
                            @if ($latestedjobs->isNotEmpty())
                                @foreach ($latestedjobs as $latestedjob)
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                <h3 class="border-0 fs-5 pb-2 mb-0">{{ $latestedjob->title }}</h3>
                                                <p>{{ Str::words($latestedjob->description, 5) }}</p>
                                                <div class="bg-light p-3 border">
                                                    <p class="mb-0">
                                                        <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                                        <span class="ps-1">{{ $latestedjob->location }}</span>
                                                    </p>
                                                    <p class="mb-0">
                                                        <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
                                                        <span class="ps-1">{{ $latestedjob->jobType->name }}</span>
                                                    </p>
                                                    @if (!is_null($latestedjob->salary))
                                                        <p class="mb-0">
                                                            <span class="fw-bolder"><i class="fa fa-usd"></i></span>
                                                            <span class="ps-1">{{ $latestedjob->salary }}</span>
                                                        </p>
                                                    @endif
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('jobDetail', $latestedjob->id) }}"
                                                        class="btn btn-primary btn-lg">Details</a>
                                                </div>
                                            </div>
                                        </div>
